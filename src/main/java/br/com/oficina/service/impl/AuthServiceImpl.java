...
import br.com.oficina.infrastructure.security.JwtTokenService;
...
public class AuthServiceImpl {
  ...
  public AuthServiceImpl(UserRepository users, PasswordEncoder encoder, JwtTokenService tokens) {
    this.users = users;
